...
| GET | `/api/ops/bank-health` | S | — | 200, 401, 503 | Сводка состояния банковских подключений по ВСЕМ порталам (#497 §3). Только счётчики: ни номеров счетов, ни `member_id`, ни доменов. Токены не расшифровываются. Сбой БД ⇒ **503**, а не пустая сводка: «ноль подключений» читалось бы как «всё спокойно» |
