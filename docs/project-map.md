...
- ✅ **Приорбанк прод — BY-crypto TLS: РЕШЕНО, вендор не нужен** (issue #41 закрыт).
  ...
  **Осталось:** живая интеграция целиком (#461 — упирается в блокер согласия выше), ротация корней
  ...
  34.101.65 — вопрос к банку письменно, и от работоспособности образа он не зависит.
  ...
  **Запасной путь — AvTunProxy (АВЕСТ):** отправлено обращение в банк с просьбой инициировать
  добавление их хостов в список ресурсов вендора. После своего шлюза это удобство, а не блокер: он не
  требует держать собственный образ.
