...
- ⬜ **Ручное разнесение из элемента смарт-процесса — НЕ СДЕЛАНО** (спека `PROCESSING.md §3/§6`; ранее в карте явно
  не отмечалось). Когда авто-разнесение выключено (`autoDistribute=OFF`) или платёж ушёл в `manual`/`ambiguous`,
  спека требует **элемент смарт-процесса** как «очередь ручного разбора» с кнопками-действиями: **«повторно
  поискать клиента»**, **«поискать что оплачено»** (ручное распределение по инвойсам/оплатам), **«разнести
  автоматически»** (запуск авто из элемента). Сейчас: `manual`/`ambiguous` только **уведомляет в чат ошибок**
  (`notifyError`), носитель-элемент СП и сами кнопки-действия §6 **не построены** (это часть «Фазы B» — элемент СП
  как носитель, `WORKLOG.md`, и регистрации действий приложения в layout). Блокеры: живой портал + платный тариф СП.
