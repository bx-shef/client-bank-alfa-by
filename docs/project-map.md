...
**Оставшееся — за ресурсами владельца/вне текущего мандата:** живой прогон провижининга+записи (платный тариф
СП), Приор async (A5b), телеметрия в Grafana (slice 2), прод-СКЗИ (#41), обратная связь клиент/ИИ (#61/#108,
базовый канал «сотрудник» уже есть). Правильность выборок и охват по `PROCESSING.md` — на треке 📥.
