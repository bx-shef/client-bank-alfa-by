...
| [`SEO.md`](SEO.md) | панели вебмастера, чек-лист проверки после выката, превью ссылок в соцсетях |
...
| Где | О чём |
|---|---|
| [`../AGENTS.md`](../AGENTS.md) | короткий указатель для AI-агентов (ведёт в `CLAUDE.md` и `AGENT_RULES.md`) |
| [`AGENT_RULES.md`](AGENT_RULES.md) | правила процесса от владельца: язык, путь работы до `main`, когда собирается панель ревьюеров, что нельзя утверждать без замера. ГЛАВНЕЕ привычек `CLAUDE.md` |
