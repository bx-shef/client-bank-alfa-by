...
и прод-метод аутентификации `private_key_jwt` вместо sandbox-only `client_secret_basic` (issue #444);
это крипто-требование РБ, не сетевое ограничение; Альфа-прод ничего из этого не требует.
