...
const PORTAL_SIDE_PATTERNS = [
  ...
  // ⚠ ЗАМЕРЕНО на боевом стенде 2026-08-25: у портала отозвали доступ к приложению в Маркете, и
  // КАЖДАЯ его операция стала падать `Subscription has been ended` — три попытки на операцию, до
