...
> **frontend**: публичный лендинг (SSG) + B24-iframe-UI (просмотр выписки/настройки на демо-данных) +
...
> Дальше на backend — OAuth-транспорт Альфы/Приора, опрос, запись дел/чата, MCP (пока не реализованы).
