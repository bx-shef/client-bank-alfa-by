...
> rate-limiter** (A8, 100/60с). Таймер default-OFF (`CRON_REAL_POLL`); Приор (async) — A5b. Для боевого
> прогона нужны **банк-креды владельца** (`ALFA_OAUTH_*`). Дальше — чат-уведомления в бою и MCP.
