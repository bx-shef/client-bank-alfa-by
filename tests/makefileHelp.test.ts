...
const OPERATOR = ['prod-up', 'prod-down', 'prod-pull', 'prod-redeploy', 'logs', 'ps',
  ...
  'bank-history',
  // #488: один запрос, проверяющий, принимает ли промышленная регистрация Альфы Password Grant —
  // тип авторизации без пользовательской сессии, из-за смерти которой подключение и умирало.
  'alfa-password-probe',
