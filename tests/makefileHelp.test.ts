...
const OPERATOR = ['prod-up', 'prod-down', 'prod-pull', 'prod-redeploy', 'logs', 'ps',
  ...
  'alfa-refresh-now',
  // #488: лестница пауз — какой простой между обновлениями банк ещё терпит. Прогон идёт сутками,
  // поэтому у него три цели: запустить, посмотреть журнал, остановить.
  'alfa-refresh-schedule', 'alfa-refresh-log', 'alfa-refresh-stop',
