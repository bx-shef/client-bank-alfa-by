...
const OPERATOR = ['prod-up', 'prod-down', 'prod-pull', 'prod-redeploy', 'logs', 'ps',
  ...
  // #466 §3: канал оповещений молчит одинаково и когда всё хорошо, и когда он выключен или сломан.
  // Ответить «доходит ли» может только сам Telegram — переменными это не проверяется.
  'alert-test',
