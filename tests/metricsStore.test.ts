...
describe('metricsFromSummary', () => {
  ...
  const summary = {
    ...
    credits: 22, debits: 23, registryFailed: 26, bindingsFailed: 27, misconfigured: 28, nonPayment: 29, unreadableAmount: 30
  }
  ...
  it('maps each counter to its OWN summary field (no transposition)', () => {
    expect(metricsFromSummary(summary)).toEqual({
      ...
      bindingsFailed: 27, misconfigured: 28, nonPayment: 29, unreadableAmount: 30
    })
  })
