...
export const VISUAL_ROUTES: readonly VisualRoute[] = [
  ...
  // `?preview=1` гранта нет, поэтому снимок фиксирует ветку отказа («ссылка неполная»): она и
  // есть то, что увидит человек, открывший адрес мимо ссылки из чата, и вёрстку ей больше никто
  // не проверяет.
