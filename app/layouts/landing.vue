...
const navItems = [
  [
    ...
    {
      // ⚠ Справка — ПУБЛИЧНАЯ страница и стоит в верхней навигации намеренно: ссылку на неё дают
      // в карточке Маркета, и человек, у которого что-то не работает, должен находить её до
      // установки приложения, а не только внутри портала.
      label: 'Справка',
      icon: OpenBookIcon,
      to: '/help'
    },
