...
export const LANDING_DESCRIPTION
  = 'Читаем выписку белорусских банков (Альфа-Банк Беларусь, Приорбанк) — онлайн из любой страны или файлом — и отправляем данные туда, куда нужно вам. Разворачиваем в вашем контуре: ваш git, ваш сервер, настройка под ваши процессы.'
...
export const LANDING_FEATURES: readonly LandingFeature[] = [
  ...
  {
    title: 'Данные — туда, куда нужно вам',
    description: 'Не только в счета Bitrix24: маршрут и правила настраиваем под ваши процессы — CRM, учётная система, внешние сервисы. Приходы и расходы, а не только поступления.'
  },
  {
