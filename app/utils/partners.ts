 ...
 *
 * Отдельно от `PARTNERS_DESCRIPTION` по той же причине, что и на главной: под hero нужен
 * развёрнутый абзац, а в `<meta name="description">` практический предел ~150–160 символов.
