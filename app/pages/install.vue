            ...
            <div class="flex flex-col gap-3 p-2 font-mono text-sm">
              <div class="grid grid-cols-[max-content_1fr] gap-x-3 gap-y-1">
                ...
                <!-- Второй, параллельный вход в экраны приложения (#19): ссылка, которую можно
                     ...
                     ⚠ ПРОЧИТАТЬ ЭТИ ДВЕ СТРОКИ ЧЕЛОВЕК НЕ УСПЕВАЕТ, и ссылаться на них в
                     инструкции нельзя (эта ошибка тут уже была). Установка — сплошной проходящий
                     процесс: `installFinish` уводит портал на главный экран раньше, чем успеваешь
                     раскрыть свёрнутый блок. Строки остаются как справка тому, кто смотрит
                     установку с открытой консолью; человеку адрес собирают руками по двум частям —
                     код приложения из адресной строки портала + `?params[place]=…`,
                     см. docs/APP_LINKS.md §«Как открыть ссылку». -->
